...
// A curated trip. Primary action goes straight to the finished itinerary (busy path);
// secondary opens the builder preselected so you can tweak before saving.
    ...
    <div className="card group flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-4 flex items-center gap-4">
          ...
          <Link href={bundleHref(bundle, false)} className="text-sm text-ink-mute underline-offset-2 hover:text-ink-soft hover:underline">Edit first</Link>
        </div>
      </div>
    </div>
  )
